...
@section('title', $title = $brand->id ? '编辑' : '添加' )

@section('breadcrumb')
    <a>基础资料</a>
    <a href="{{ route('admin.brands') }}">品牌列表</a>
    <a><cite>{{$title}}</cite></a>
@endsection
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="name" required lay-verify="required" placeholder="请输入名称"
                                       autocomplete="off" class="layui-input" value="{{ old('name',$brand->name) }}">
                            </div>
                        </div>
                        <div class="layui-form-item">
    ...
    <script>
        ...
        layui.use('form', function () {
            ...
            form.on('submit(formCommit)', function (data) {
                let url = "{{$brand->id?route('admin.brands.update',$brand->id):route('admin.brands.store')}}";
                    ...
                    success: function (result) {
                        ...
                        if (!result.success) {
                            ...
                            layer.alert(msg, function (index) {
                                ...
                                window.location.href = "{{ url('admin/brands/edit') }}/" + result.model.id;
