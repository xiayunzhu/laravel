...
let cityData = [
    ...
    }, 
    {
        ...
        'city': [
            {
                'name': '杭州市', 
                'area': ['拱墅区', '西湖区', '上城区', '下城区', '江干区', '滨江区', '余杭区', '萧山区', '富阳区', '临安区', '桐庐县', '建德市', '淳安县']
            }, 
            {
                'name': '宁波市', 
    ...
    }, 
    {
        ...
        'city': [
            ...
            {
                'name': '苏州市', 
                'area': ['姑苏区', '吴中区', '相城区', '高新区', '工业园区', '吴江区', '常熟市', '张家港市', '昆山市',  '太仓市']
            }, 
            {
                'name': '无锡市', 
    ...
    }, 
    {
        ...
        'city': [
            {
                'name': '石家庄市', 
                'area': ['长安区', '桥西区', '新华区', '裕华区', '井陉矿区', '藁城区', '鹿泉区', '栾城区', '晋州市 ', '新乐市', '正定县', '井陉县', '赵县', '高邑县', '元氏县', '赞皇县', '平山县', '灵寿县', '行唐县', '无极县', '深泽县', '辛集市']
            }, 
            {
                'name': '唐山市', 
    ...
    },
    {
        ...
        'city': [
            {
                'name': '成都市', 
                'area': ['青羊区', '锦江区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '天府新区', '都江堰市', '彭州市', '邛崃市', '崇州市', '金堂县', '郫县', '新津县', '双流县', '蒲江县', '大邑县']
            }, 
            {
                'name': '自贡市', 
    ...
    }, 
    {
        ...
        'city': [
            {
                'name': '兰州市', 
                'area': ['城关区', '七里河区', '西固区', '安宁区', '红古区', '永登县', '皋兰县', '榆中县', '兰州新区']
            }, 
            {
                'name': '嘉峪关市', 
                'area': ['嘉峪关市']
    ...
    },  
    {
        ...
        'city': [
            ...
            {
                'name': '伊犁哈萨克自治州', 
                'area': ['伊宁市', '奎屯市', '伊宁县', '特克斯县', '尼勒克县', '昭苏县', '新源县', '霍城县', '巩留县', '察布查尔锡伯自治县', '阿勒泰地区']
            },
            {
                'name': '塔城地区', 
                'area': ['塔城市', '乌苏市', '额敏县', '裕民县', '沙湾县', '托里县', '和布克赛尔县']
            }
        ]
    }, 
    {
